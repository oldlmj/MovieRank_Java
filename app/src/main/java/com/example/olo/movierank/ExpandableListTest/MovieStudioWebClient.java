...
public class MovieStudioWebClient extends Activity {


    public static final String MovieStudUrl = "cheese_name";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = intent.getStringExtra(MovieStudUrl);
        ...
        myWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                MovieStudioWebClient.this.setTitle("載入中........") ;
